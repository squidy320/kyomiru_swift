...
#define __GMP_CFLAGS "-arch arm64 -isysroot /Applications/Xcode_16.4.app/Contents/Developer/Platforms/AppleTVOS.platform/Developer/SDKs/AppleTVOS18.5.sdk -target arm64-apple-tvos13.0 -mtvos-version-min=13.0 -DHAVE_FORK=0"
